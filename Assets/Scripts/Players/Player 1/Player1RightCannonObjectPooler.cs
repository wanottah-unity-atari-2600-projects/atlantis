...
//
// Atlantis v2021.03.03
//
// 2021.02.27
//

public class Player1RightCannonObjectPooler : MonoBehaviour
{
    public static Player1RightCannonObjectPooler player1RightCannonObjectPooler;
    ...
    private void Awake()
    {
        player1RightCannonObjectPooler = this;
    }
    ...
    private void CreatePooledObject()
    {
        ...
        pooledGameObject.name = "Player 1 Right Torpedo";
