...
public class Player1LeftCannonObjectPooler : MonoBehaviour
{
    public static Player1LeftCannonObjectPooler player1LeftCannonObjectPooler;
    ...
    private void Awake()
    {
        player1LeftCannonObjectPooler = this;
    }
    ...
    private void CreatePooledObject()
    {
        ...
        pooledGameObject.name = "Player 1 Left Torpedo";
