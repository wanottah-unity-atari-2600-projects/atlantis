...
public class RightEnemy3Controller1 : MonoBehaviour
{
    public static RightEnemy3Controller1 rightEnemy3Controller1;
    ...
    private void DisableShip()
    {
        ...
        EnemyController.enemyController.rightShipActive1 = false;
    }
