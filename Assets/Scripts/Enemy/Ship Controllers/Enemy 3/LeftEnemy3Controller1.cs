...
public class LeftEnemy3Controller1 : MonoBehaviour
{
    public static LeftEnemy3Controller1 leftEnemy3Controller1;
    ...
    private void DisableShip()
    {
        ...
        EnemyController.enemyController.leftShipActive1 = false;
    }
