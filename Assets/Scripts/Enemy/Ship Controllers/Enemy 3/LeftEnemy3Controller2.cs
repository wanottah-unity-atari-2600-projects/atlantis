...
public class LeftEnemy3Controller2 : MonoBehaviour
{
    public static LeftEnemy3Controller2 leftEnemy3Controller2;
    ...
    private void DisableShip()
    {
        ...
        EnemyController.enemyController.leftShipActive2 = false;
    }
