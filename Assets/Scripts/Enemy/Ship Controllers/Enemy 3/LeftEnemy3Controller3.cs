...
public class LeftEnemy3Controller3 : MonoBehaviour
{
    public static LeftEnemy3Controller3 leftEnemy3Controller3;
    ...
    private void DisableShip()
    {
        ...
        EnemyController.enemyController.leftShipActive3 = false;
    }
